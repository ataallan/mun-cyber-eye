...
docs/            ARCHITECTURE.md, ETHICS_AND_SAFETY.md, PHASE3.md, PHASE3b.md, SPORTS_AND_AGGRESSION.md, SCENE_CONTEXT.md, OBJECTS_AND_STRUCTURES.md, GUNSHOTS_AND_FALLS.md, PHASE4.md, PHASE5.md
